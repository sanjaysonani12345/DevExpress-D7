...
uses
  Windows, Classes, SysUtils, Variants, Contnrs, Graphics, Types;

const
  dxBuildNumber: Cardinal = 20110205;
...
{$ENDIF}
  ...
  ['{2E98047F-1A56-4599-D9F1-A7245E704F5C}']
  ...
  begin
    ...
    try
      ...
      begin
        ...
        begin
          AScanLineResult := GetDIBits(ADC, ABitmap.Handle, I, 1, @AColors[ABitmap.Width * I], ABitmapInfo, DIB_RGB_COLORS) <> 0;
          if not AScanLineResult then
          begin
            P := cxAllocMem(ABitmap.Width * SizeOf(TRGBQuad));
            try
              AScanLineResult := GetDIBits(ADC, ABitmap.Handle, I, 1, P, ABitmapInfo, DIB_RGB_COLORS) <> 0;
